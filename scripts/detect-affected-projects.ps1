...
$packageMap = [ordered]@{
    "Core" = @{
        patterns = @("src/EricksonLopez.Caching/", "tests/EricksonLopez.Caching.Tests/")
        config = "stryker-config.json"
        outputDir = "StrykerOutput/core"
        artifact = "stryker-report-core"
    }
    "Redis" = @{
        patterns = @("src/EricksonLopez.Caching.Redis/", "tests/EricksonLopez.Caching.Redis.Tests/")
...
$globalTriggers = @("Directory.Build.props", "Directory.Packages.props", "EricksonLopez.Caching.slnx", ".editorconfig")
